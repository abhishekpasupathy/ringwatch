...
import { ShieldCheck, AlertTriangle, Eye, Zap, Activity, Network, Target } from "lucide-react";
  ...
  return (
    <div className="dashboard-shell flex flex-col h-screen text-white overflow-hidden">
      ...
      <div className="flex-shrink-0 px-5 lg:px-7 py-2 border-b border-white/[.06] bg-[#080b11] flex items-center gap-3">
        <div className="section-label hidden sm:flex items-center gap-2 whitespace-nowrap"><Target size={12} /> ACCOUNT SEARCH</div>
